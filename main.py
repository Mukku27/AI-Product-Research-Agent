...
from agent_orchestrator import run_patent_analysis
from search_tools import hybrid_search, iterative_search, semantic_search, keyword_search
...
def check_system_status():
    ...
    try:
        from semantic_encoder import get_embedding
